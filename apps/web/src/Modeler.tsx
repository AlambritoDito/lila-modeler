 ...
 * es un carril y quién no tiene padre —la raíz— (`PropertiesPanel.tsx`, diseño 2d). `waypoints`
 * es lo que de verdad distingue una figura de una conexión ahí: bpmn-js le da a una conexión un
