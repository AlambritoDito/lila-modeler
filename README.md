...
double-clicking it in Finder (see the beta guide: the open-file route was verified for Beta 1; a physical Finder double-click was not). Found a reproducible
