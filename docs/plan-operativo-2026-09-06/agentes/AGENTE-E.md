# Agente E — Escenarios, comparación y documentación
...
Usa tu propio worktree y rama. Propuesta de rama: `codex/op-e-paneles`. Ruta propuesta en la Mac: `../lila-wt-e-paneles` desde el repo original. En otra computadora usa un clone propio y una ruta local; intercambia commits por el remoto privado. Antes de empezar verifica que nadie más escribe ese worktree y registra SHA, sistema operativo y arquitectura. El commit del plan debe estar presente.

## Orden de trabajo

1. [OP-05](../tickets/OP-05.md): Hacer la comparación interpretable.
2. [OP-11](../tickets/OP-11.md): Completar edición de escenarios y calendarios.
3. [OP-17](../tickets/OP-17.md): Dejar guía de uso, licencias y soporte de agentes.
...
Informa brevemente: `Agente E; host/arquitectura; worktree; rama; SHA base; primer OP; dependencias que necesito`. Después ejecuta. Al finalizar informa lo conseguido con enlaces a commits/artefactos y pruebas, sin pedir permiso para seguir con trabajo ya asignado.
